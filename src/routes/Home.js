    ...
    <div className="Home" >
      ...
      <Grid container sm={12} md={11}  direction='column' justify='flex-start' spacing={5}>
        <Grid container style={{marginTop: 50}}  direction = 'row' spacing={2}>
          ...
          <Grid container sm={12} md={10}><Grid item ><div className='text-normal'>I am a senior student studing <a href='https://id.kaist.ac.kr'> Industrial Design</a> at KAIST</div></Grid></Grid>
        </Grid>
        <Grid container style={{marginTop: 50}} direction = 'row' spacing={2}>
